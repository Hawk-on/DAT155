...
let vertices = [
    ...
    // Bronze
    let materialAmbient = vec4( 0.2125, 0.1275, 0.054, 1.0 );
    let materialDiffuse = vec4( 0.714, 0.4284, 0.18144, 1.0);
    let materialSpecular = vec4( 0.393548, 0.271906, 0.166721, 1.0 );
    let materialShininess = 25.6;
